...
namespace PeterDB {
    ...
    protected:
        ...
        void splitNode(IXFileHandle &fh, char *pageData, char *newPage, const Attribute &attr, const void *key, const RID &rid, unsigned pageNum, SizeType slot, const void * & pushUpKey);
